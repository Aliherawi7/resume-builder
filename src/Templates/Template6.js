...
function Template6({ contactInformation, experiences, experience, educations, education, skills, summery, color, font }) {
    ...
    return (
        <div className='template template6 a4'>
